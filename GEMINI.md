...
9. **Código Numérico Sequencial Crescente**: Todo e qualquer cadastro efetuado no sistema (ex: Grupos de Gestão, Linhas de Gestão, Clientes, Fornecedores, Centro de Custos, Títulos, etc.) DEVE obrigatoriamente gerar automaticamente um código numérico padrão em ordem sequencial crescente (ex: 001, 002, 003...).
