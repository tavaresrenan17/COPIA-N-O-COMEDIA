...
// Mock Data: Plano Financeiro do cliente — o MESMO das migrations, para que
// o que se testa local bata com o que existe no banco.
let mockPlanoContas: PlanoConta[] = [
  { id: 'pc-1', codigo: '1', nome: 'ENTRADAS/RECEITAS', parentId: null, natureza: 'receita', nivel: 1, aceitaLancamento: false, ativo: true },
  { id: 'pc-1.01', codigo: '1.01', nome: 'RECEITA OPERACIONAL', parentId: 'pc-1', natureza: 'receita', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-1.01.01', codigo: '1.01.01', nome: 'Receita de Serviços', parentId: 'pc-1.01', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.01.02', codigo: '1.01.02', nome: 'Sinal do contrato com cliente', parentId: 'pc-1.01', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.01.03', codigo: '1.01.03', nome: 'Entrada do contrato', parentId: 'pc-1.01', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.01.04', codigo: '1.01.04', nome: '(-)ISS s/ Serviços', parentId: 'pc-1.01', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.01.05', codigo: '1.01.05', nome: '(-)INSS s/ Serviços', parentId: 'pc-1.01', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.02', codigo: '1.02', nome: 'EMPRÉSTIMOS E FINANCIAMENTOS', parentId: 'pc-1', natureza: 'receita', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-1.02.01', codigo: '1.02.01', nome: 'Aporte de Sócio', parentId: 'pc-1.02', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.02.02', codigo: '1.02.02', nome: 'Empréstimo terceiros', parentId: 'pc-1.02', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.03', codigo: '1.03', nome: 'VENDAS E LOCAÇÕES', parentId: 'pc-1', natureza: 'receita', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-1.03.01', codigo: '1.03.01', nome: 'Locação de Equipamentos/Máquinas', parentId: 'pc-1.03', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.03.02', codigo: '1.03.02', nome: 'Venda de materiais de obra', parentId: 'pc-1.03', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.03.03', codigo: '1.03.03', nome: 'Venda de ferramentas', parentId: 'pc-1.03', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.04', codigo: '1.04', nome: 'ENTRADA INTERNA', parentId: 'pc-1', natureza: 'receita', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-1.04.01', codigo: '1.04.01', nome: 'Recebimento interno', parentId: 'pc-1.04', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-1.05', codigo: '1.05', nome: 'DESCONTOS', parentId: 'pc-1', natureza: 'receita', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-1.05.01', codigo: '1.05.01', nome: '(-)Descontar do Funcionário', parentId: 'pc-1.05', natureza: 'receita', nivel: 3, aceitaLancamento: true, ativo: true },

  { id: 'pc-2', codigo: '2', nome: 'SAÍDAS / CUSTOS / DESPESAS', parentId: null, natureza: 'despesa', nivel: 1, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.01', codigo: '2.01', nome: 'MÃO DE OBRA E ENCARGOS', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.01.01', codigo: '2.01.01', nome: 'Salários e ordenados', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.02', codigo: '2.01.02', nome: 'Diárias combinadas', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.03', codigo: '2.01.03', nome: 'Serviços Terceirizados e Empreiteiros', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.04', codigo: '2.01.04', nome: 'Férias', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.05', codigo: '2.01.05', nome: '13º Salário', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.06', codigo: '2.01.06', nome: 'Bonificações', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.07', codigo: '2.01.07', nome: 'Salário Família', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.10', codigo: '2.01.10', nome: 'Alimentação', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.11', codigo: '2.01.11', nome: 'Transporte', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.12', codigo: '2.01.12', nome: 'Custeio de Treinamento', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.13', codigo: '2.01.13', nome: 'Assistência médica', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.14', codigo: '2.01.14', nome: 'Custo de Rescisão', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.15', codigo: '2.01.15', nome: 'Seguro de vida', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.16', codigo: '2.01.16', nome: 'Uniformes e EPI\'s', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.17', codigo: '2.01.17', nome: 'Medicina Ocupacional', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.18', codigo: '2.01.18', nome: 'Horas extras', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.19', codigo: '2.01.19', nome: 'Adiantamento e Vales Diaristas', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.20', codigo: '2.01.20', nome: 'Pagamento Empresas', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.21', codigo: '2.01.21', nome: 'Salários CLT', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.22', codigo: '2.01.22', nome: 'Salários PJ', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.23', codigo: '2.01.23', nome: 'Salários Estagiários', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.24', codigo: '2.01.24', nome: 'Adiantamento e Vales PJ', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.25', codigo: '2.01.25', nome: 'Adiantamento e Vales CLT', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.01.26', codigo: '2.01.26', nome: 'Seguro de vida dos funcionários', parentId: 'pc-2.01', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.02', codigo: '2.02', nome: 'AUTUAÇÕES E INFRAÇÕES', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.02.01', codigo: '2.02.01', nome: 'Multas e Correções por Atraso de no pagamento', parentId: 'pc-2.02', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.02.02', codigo: '2.02.02', nome: 'Autuações Fiscais', parentId: 'pc-2.02', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.02.03', codigo: '2.02.03', nome: 'Infrações de Trânsito', parentId: 'pc-2.02', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.02.04', codigo: '2.02.04', nome: 'Infrações Ambientais (Ruído, Limpeza, Licenças)', parentId: 'pc-2.02', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03', codigo: '2.03', nome: 'CONTAS DE OBRAS', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.03.01', codigo: '2.03.01', nome: 'Materiais de Obra', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.02', codigo: '2.03.02', nome: 'Aquisição de ferramentas', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.03', codigo: '2.03.03', nome: 'Aluguéis de imóveis', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.04', codigo: '2.03.04', nome: 'Condomínio', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.05', codigo: '2.03.05', nome: 'Água e esgoto', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.06', codigo: '2.03.06', nome: 'Energia Elétrica', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.07', codigo: '2.03.07', nome: 'Gás', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.08', codigo: '2.03.08', nome: 'Aquisição de móveis e utensílios', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.09', codigo: '2.03.09', nome: 'Material de Escritório', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.10', codigo: '2.03.10', nome: 'Material de Limpeza', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.11', codigo: '2.03.11', nome: 'Locação de ferramentas', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.12', codigo: '2.03.12', nome: 'Abastecimento', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.13', codigo: '2.03.13', nome: 'Sinalização de obra', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.14', codigo: '2.03.14', nome: 'Despesas com Cartórios e Legalizações', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.15', codigo: '2.03.15', nome: 'Fretes e Entrega', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.16', codigo: '2.03.16', nome: 'Equipamentos Eletrônicos', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.17', codigo: '2.03.17', nome: 'Provedores de Internet', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.18', codigo: '2.03.18', nome: 'Licenças de Softwares', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.19', codigo: '2.03.19', nome: 'Manutenção de Veículos', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.20', codigo: '2.03.20', nome: 'Aquisição de Equipamentos', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.21', codigo: '2.03.21', nome: 'Aquisição de Veículos', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.22', codigo: '2.03.22', nome: 'Seguro de Veículos', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.23', codigo: '2.03.23', nome: 'Pedágio/Estacionamento', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.24', codigo: '2.03.24', nome: 'Locação de Veículo', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.25', codigo: '2.03.25', nome: 'Passagens', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.26', codigo: '2.03.26', nome: 'Hospedagem', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.27', codigo: '2.03.27', nome: 'Custo de vida Engenheiro(a)', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.28', codigo: '2.03.28', nome: 'Projetos', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.29', codigo: '2.03.29', nome: 'Telefone', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.30', codigo: '2.03.30', nome: 'Eventos da empresa', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.31', codigo: '2.03.31', nome: 'Locação de Máquinas', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.32', codigo: '2.03.32', nome: 'Reembolso de KM', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.33', codigo: '2.03.33', nome: 'Licença Médica', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.34', codigo: '2.03.34', nome: 'Manutenção Geral', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.35', codigo: '2.03.35', nome: 'Reembolso Geral', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.36', codigo: '2.03.36', nome: 'Equipamentos', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.37', codigo: '2.03.37', nome: 'Caixinha', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.03.38', codigo: '2.03.38', nome: 'Despesas Veiculos', parentId: 'pc-2.03', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.04', codigo: '2.04', nome: 'SERVIÇOS ESPECIALIZADOS', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.04.01', codigo: '2.04.01', nome: 'Assessoria Jurídica', parentId: 'pc-2.04', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.04.02', codigo: '2.04.02', nome: 'Assessoria Contábil', parentId: 'pc-2.04', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.04.03', codigo: '2.04.03', nome: 'Assessoria R.H', parentId: 'pc-2.04', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.04.04', codigo: '2.04.04', nome: 'Consultoria em T.I', parentId: 'pc-2.04', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.04.05', codigo: '2.04.05', nome: 'Assessoria de Qualidade', parentId: 'pc-2.04', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.04.06', codigo: '2.04.06', nome: 'Assessoria de Marketing', parentId: 'pc-2.04', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.04.07', codigo: '2.04.07', nome: 'Assessoria de Dados', parentId: 'pc-2.04', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.04.08', codigo: '2.04.08', nome: 'Assessoria de Segurança', parentId: 'pc-2.04', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.05', codigo: '2.05', nome: 'DESPESAS DOS SÓCIOS', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.05.01', codigo: '2.05.01', nome: 'Retirada de Sócios', parentId: 'pc-2.05', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.05.02', codigo: '2.05.02', nome: 'Contas Pessoais', parentId: 'pc-2.05', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.05.03', codigo: '2.05.03', nome: 'Devolução de aporte', parentId: 'pc-2.05', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.05.04', codigo: '2.05.04', nome: 'Investimentos em conjunto', parentId: 'pc-2.05', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.06', codigo: '2.06', nome: 'DESPESAS FINANCEIRAS', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.06.01', codigo: '2.06.01', nome: 'Tarifas Diversas', parentId: 'pc-2.06', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.06.02', codigo: '2.06.02', nome: 'Taxa de Aquisição de Crédito', parentId: 'pc-2.06', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.06.03', codigo: '2.06.03', nome: 'Juros sobre Empréstimos', parentId: 'pc-2.06', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.06.04', codigo: '2.06.04', nome: 'Multas e Acréscimos', parentId: 'pc-2.06', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.06.05', codigo: '2.06.05', nome: 'IPTU', parentId: 'pc-2.06', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.06.06', codigo: '2.06.06', nome: 'Quitação empréstimo', parentId: 'pc-2.06', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.07', codigo: '2.07', nome: 'CONTENCIOSO', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.07.01', codigo: '2.07.01', nome: 'Ações Trabalhistas', parentId: 'pc-2.07', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.07.02', codigo: '2.07.02', nome: 'Ações Civis Diversas', parentId: 'pc-2.07', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.08', codigo: '2.08', nome: 'DÍVIDAS RECONHECIDAS', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.08.01', codigo: '2.08.01', nome: 'Dívida com Funcionário', parentId: 'pc-2.08', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.08.02', codigo: '2.08.02', nome: 'Dívida com Governo', parentId: 'pc-2.08', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.08.03', codigo: '2.08.03', nome: 'Dívida com Banco', parentId: 'pc-2.08', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.08.04', codigo: '2.08.04', nome: 'Dívida com Fornecedor', parentId: 'pc-2.08', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.10', codigo: '2.10', nome: 'DESPESAS TRIBUTÁRIAS', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.10.01', codigo: '2.10.01', nome: 'GUIA PIS', parentId: 'pc-2.10', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.10.02', codigo: '2.10.02', nome: 'GUIA COFINS', parentId: 'pc-2.10', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.10.03', codigo: '2.10.03', nome: 'GUIA ISS', parentId: 'pc-2.10', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.10.04', codigo: '2.10.04', nome: 'GUIA IRPJ', parentId: 'pc-2.10', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.10.05', codigo: '2.10.05', nome: 'GUIA CSLL', parentId: 'pc-2.10', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.10.06', codigo: '2.10.06', nome: 'GUIA DAS (SIMPLES)', parentId: 'pc-2.10', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.10.07', codigo: '2.10.07', nome: 'GUIA MEI', parentId: 'pc-2.10', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11', codigo: '2.11', nome: 'TRIBUTOS E ENCARGOS DA FOLHA DE PAGAMENTO', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.11.01', codigo: '2.11.01', nome: 'INSS Funcionários', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.02', codigo: '2.11.02', nome: 'INSS Patronal (Desoneração)', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.03', codigo: '2.11.03', nome: 'FGTS', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.04', codigo: '2.11.04', nome: 'FGTS Rescisório', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.05', codigo: '2.11.05', nome: 'IRRF Terceiros PF (0588)', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.06', codigo: '2.11.06', nome: 'IRRF Terceiros PJ (1708)', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.07', codigo: '2.11.07', nome: 'Contribuição Sindical Confederativa', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.08', codigo: '2.11.08', nome: 'Contribuição Sindical Patronal', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.09', codigo: '2.11.09', nome: 'Entidades/Conselhos de Classe (CREA, CRA)', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.10', codigo: '2.11.10', nome: 'Cofre Leis Sociais', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.11.11', codigo: '2.11.11', nome: 'Guia DARF', parentId: 'pc-2.11', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
  { id: 'pc-2.12', codigo: '2.12', nome: 'SAÍDA INTERNA', parentId: 'pc-2', natureza: 'despesa', nivel: 2, aceitaLancamento: false, ativo: true },
  { id: 'pc-2.12.01', codigo: '2.12.01', nome: 'Saída interna', parentId: 'pc-2.12', natureza: 'despesa', nivel: 3, aceitaLancamento: true, ativo: true },
];
